...
import armageddon from '../../images/armageddonCarousel.jpg';
import astarisborn from '../../images/astarisbornCarousel.jpg';
...
const items = [
  ...
  {
    src: thegreatestshowman
  }
];

export default class FrontpageCarousel extends Component {
  constructor(props) {
    super(props);
