...
import candyShop from '../../images/godisbutik.jpg';
...
const Startpage = () => {
  return (
    <Container>
      ...
      <Row>
        <Col xs="12" lg="6">
          <h1 className="frontHeadline visitor-info ">Information till våra besökare</h1>
          <p className="frontParagraph infoForAll ">För allas trivsel har vi en del regler på denna biograf som måste följas vilket är följande:</p>
          <p className="frontParagraph ">
            <i className="fas fa-user-slash "></i> När fimen startat ska alla mobiltelefoner vara på ljudlöst läge eller avstängda.
          </p>
          <p className="frontParagraph ">
            <i className="fas fa-user-slash "></i> Ta med allt skräp och släng det i våra papperskorgar som är lokerade vid utgången när filmen är slut.
          </p>
          <p className="frontParagraph ">
            <i className="fas fa-user-slash "></i> Visa respekt för alla i salongen genom att vara tyst under filmens gång.
          </p>
          <h1 className="frontHeadline ">IMAX Ljud och Bild</h1>
          <p className="frontParagraph ">En förvånansvärt stor del av IMAX-upplevelsen utgörs av ljudet. Det är det som gör en IMAX-film till en fysisk upplevelse. En IMAX-film är inte bara något du ser – den känns i hela kroppen. En bidragande orsak till det är den rena kraften
          ...
          <p className="frontParagraph ">Allt fler ledande filmskapare använder patentskyddade IMAXkameror för att filma delar av sina filmer. IMAXkameror har världens högsta upplösning och används med 70 mm-film som projicerar en bild med tio gånger högre upplösning än 35 mm-film.
        ...
        <Col xs="12" lg="6">
          <h1 className="frontHeadline visitor-info ">Vi har godis och popcorn!</h1>
          <img src={candyShop} className="candyShop img-fluid" alt="" />
          <p className="frontParagraph candyInfo ">Vi har en godisbutik med allt från godis till popcorn. Denna butik öppnar en timme innan den första visningen och stänger när den sista visningen för dagen börjat. Vi har olika popcorn menyer där dryck ingår, och dessa just nu säljs mest.
